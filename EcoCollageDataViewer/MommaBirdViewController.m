...
@interface MommaBirdViewController () <CBCentralManagerDelegate, CBPeripheralDelegate>
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error
{
    ...
    /*
     NSArray *intArray = [[[NSString alloc] initWithData:characteristic.value encoding:NSASCIIStringEncoding] componentsSeparatedByString:@"|"];
     
     int study = [[intArray objectAtIndex:0] integerValue];
     int trial = [[intArray objectAtIndex:1] integerValue];
     
     NSLog(@"Study: %d Trial: %d", study, trial);
     */
    ...
    if ([stringFromData isEqualToString:@"EOM"]) {
        ...
        //[self.profileTextView setText:[[NSString alloc] initWithData:self.data encoding:NSUTF8StringEncoding]];
        [self.profileTextView setText:stringToDisplay];
