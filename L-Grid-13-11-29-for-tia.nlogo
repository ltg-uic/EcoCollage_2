...
;show outflow-gallons
 ...
 ;;sets up query to db and then executes the query
 
 ;includes greatest extent
...
;    "waterInRainBarrels, waterInSwales, waterInAlleys, greatestStandingWater, greatestDepthPuddle, mostCellsFlood,"
;    "mostCellsLargeFlood, timeToFlood, timeToLargeFlood, timeOfFlood, timeOfLargeFlood,"
...
;    "greatestDepthPuddleN, mostCellsFloodN, mostCellsLargeFloodN, timeToFloodN, timeToLargeFloodN, timeOfFloodN, timeOfLargeFloodN,"
...
;    global-green-alleys-ft3 ", " global-standing-water-ft3 "," greatest-depth-standing-water-ft"," greatest-extent-lesser-flood ","
;    greatest-extent-greater-flood "," time-to-lesser-flood "," time-to-greater-flood "," time-duration-lesser-flood", "time-duration-greater-flood", " 
...
;    Normalized-global-outflow-ft3", " Normalized-global-sewer-ft3"," global-efficiency-total" , " global-efficiency-green-roof" , "
;    global-efficiency-rain-barrel", "global-efficiency-swales "," global-efficiency-green-alleys-ft3 ", " Normalized-global-standing-water-ft3 "," 
;    Normalized-greatest-depth-standing-water-ft"," Normalized-greatest-extent-lesser-flood "," Normalized-greatest-extent-greater-flood "," 
...
1399
675
Cost of Private Storm Damage (%); average damage to contents and structure
Cost-private-storm-damage
2
1
11
...
1298
627
Cost of Public Storm Damage ($); sewer treatment
Cost-public-storm-damage
2
1
11
...
redo inflow (half of upstream rain per tick?)
...
Switch back the results.txt file from resultsalt.txt
...
3. Inflow limit
Metrics about flood depth and greatest extent of flood
7. Normalization values


Discuss w/Moira:
1. extra inlets
2. treatment costs ($240 per million gallons so ~150 for the two blocks
